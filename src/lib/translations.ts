export const translations = {
  pt: {
    ...
    // Dashboard Specific
    dashboardSubtitle: "Acompanhe seu progresso",
    teacherDashboardSubtitle: "Gerencie suas aulas e alunos",
    adminDashboardSubtitle: "Gerencie suas aulas e alunos",
    yourProgress: "Seu Progresso",
    completedLessons: "Aulas Concluídas",
    averageRating: "Avaliação Média",
    leaveFeedbackAbout: "Deixe um feedback sobre as aulas com o seu professor",
    recentActivity: "Atividade Recente",
    configurations: "Configurações",
    newAvailability: "Nova Disponibilidade",
    weekSchedule: "Cronograma da Semana",
  ...
  en: {
    ...
    // Dashboard Specific
    dashboardSubtitle: "Track your progress",
    teacherDashboardSubtitle: "Manage your classes and students",
    adminDashboardSubtitle: "Manage your classes and students",
    yourProgress: "Your Progress",
    completedLessons: "Completed Lessons",
    averageRating: "Average Rating",
    leaveFeedbackAbout: "Leave feedback about the lessons with your teacher",
  ...
  es: {
    ...
    teacherDashboardSubtitle: "Gestiona tus clases y estudiantes",
    adminDashboardSubtitle: "Gestiona tus clases y estudiantes",
    yourProgress: "Tu Progreso",
    completedLessons: "Clases Completadas",
    averageRating: "Calificación Promedio",
    leaveFeedbackAbout: "Deja comentarios sobre las clases con tu profesor",
